  ...
  const renderContent = () => {
      switch (activeTopic) {
          case 'Bancos':
              return (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                      <h3 className="text-xl font-bold text-ink">Gerenciando Bancos</h3>
          ...
          case 'Previsões':
              return (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                      <h3 className="text-xl font-bold text-ink">Contas a Pagar e Receber (Previsões)</h3>
                      <p className="text-muted">
          ...
          case 'Lançamentos':
              return (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                      <h3 className="text-xl font-bold text-ink">Lançamentos Financeiros</h3>
                      <p className="text-muted">
          ...
          case 'Importar Extrato':
              return (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                      <h3 className="text-xl font-bold text-ink">Importação de Arquivo OFX</h3>
                      <p className="text-muted">
          ...
          case 'Regra de importação':
              return (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                      <h3 className="text-xl font-bold text-ink">Automação com Regras</h3>
                      <p className="text-muted">
          ...
          case 'Categorias':
              return (
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                      <h3 className="text-xl font-bold text-ink">Plano de Contas (Categorias)</h3>
                      <p className="text-muted">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-ink">Tutorial do Sistema</h1>
            <p className="text-muted">Aprenda a utilizar cada módulo da plataforma</p>
          </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {/* Content Area */}
          <div className="lg:col-span-3 bg-surface border border-line rounded-xl p-8 min-h-[400px] shadow-xl">
              {renderContent()}
          </div>
      </div>
    </div>
